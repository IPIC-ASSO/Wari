...
public class EcranMenu extends ScreenAdapter {
    ...
    public void show() {
        ...
        EcranJeux.Perso.WIDTH = (90*200)/260;
    ...
    public void creerCarte(TiledMapTileLayer calque1, TiledMapTileLayer calque2){
        ...
        int debRetourY = (int) (MONDE_HAUTEUR);
        ...
        for (int y = 96/echelle; y < (128/echelle);y++){
            ...
            for (TextureRegion tuile : TextureRegion.split(retour,calque1.getTileWidth(),calque1.getTileHeight())[y]) {
                ...
                cell = new TiledMapTileLayer.Cell();
                cell.setTile(new StaticTiledMapTile(tuile));
                calque1.setCell(x+debRetourX,debRetourY - y+(32/echelle), cell);
            }
        }
    ...
    public void infos(){
        final Dialog dialog = new Dialog("", skin) {
            ...
            public float getPrefHeight() {
                //renvoie la hauteur
                return Gdx.graphics.getHeight()/1.5F;
            }
        };
        InputMultiplexer multiplexer = new InputMultiplexer();
        multiplexer.addProcessor(etage);
        Gdx.input.setInputProcessor(multiplexer);
        dialog.setWidth(Gdx.graphics.getWidth());
        dialog.setModal(true);
        dialog.setMovable(false);
        dialog.setResizable(false);
        dialog.add("LE PROJET W.A.R.I \n Jeux de plateforme développé par la société IPIC&cie©2022, tous droits réservés. \n Politique de confidentialité: (lien indisponible) \n Nous contacter: ipic.assistance@protonmail.com");
