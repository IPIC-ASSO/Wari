...
public class EcranBoutique extends ScreenAdapter {
    ...
    private Image image;
    private final Integer[] prix = {0,20,30,40,50,50};
    ...
    public void show() {
        ...
        microTable.add(new Image(TextureRegion.split(new Texture("icons.png"),32,32)[7][0]));
    ...
    public void magasin(){
        choix = 0;
        Table tableDefillante1 = new Table();
